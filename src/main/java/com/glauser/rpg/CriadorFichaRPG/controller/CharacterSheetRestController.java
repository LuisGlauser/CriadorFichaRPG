...
public class CharacterSheetRestController {
    ...
    public CharacterSheetRestController(CharacterService characterService) { this.characterService = characterService; }

    @PatchMapping("/{id}")
    public ResponseEntity<CharacterSheetResponseDTO> patch(@PathVariable String id, @RequestBody CharacterPatchDTO patch) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<CharacterSheetResponseDTO> put(@PathVariable String id, @RequestBody CharacterPatchDTO update) {
